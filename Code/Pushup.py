...
# Set the range for the push-up exercise
min_allowed_angle = 160  # Min angle at elbow when lowering
max_allowed_angle = 210  # Max angle at elbow when pushing up
    ...
    while cap.isOpened():
        ...
        if results.pose_landmarks:
            try:
                ...
                # Get coordinates for push-up exercise
                ...
                # Stage transitions
                if current_angle < max_allowed_angle and current_angle > max_allowed_angle - 10 and stage == "up":
                    stage = "down"

                if current_angle > min_allowed_angle and current_angle < min_allowed_angle + 10 and stage == "down":
                    stage = "up"
                    if f == 1:
                        counter += 1
                    else:
        ...
        cv2.imshow('Push-Up Exercise Form Correction', image)
